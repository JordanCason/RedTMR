...
// redux
import { acceptVulnAction, bountySubmissionStateIndexAction, denyVulnAction, testAction2 } from '../../redux_actions/action_bountyCurrent.js'
...
class DisplayBounty extends Component {
    ...
    render = () => {
        ...
        let index = this.props.bountyCurrent.bountySubmissionStateIndex
                                    ...
                                    ? <div>
                                        ...
                                        </table>
                                        {
                                            Object.keys(this.props.bountyCurrent.bountySubmissionState).map((key, index) => ( // count links to the correct
                                                <div key={key} onClick={() => { this.props.bountySubmissionStateIndexAction(key) }}>
