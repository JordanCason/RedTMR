                    ...
                    <div className="head1">{this.props.Values.header}</div>
                        <div className="columnWrapper" style={{height: this.props.Values.height}}>
                            <table className="myTable">
                                ...
                                <tr onClick={() => this.props.tableClickAction(key.key, this.props.Values.reduxTableName)} className={this.props.tableClick[this.props.Values.reduxTableName] === key.key ? 'active': null} key={key.key}>
                                    <td>{key.weakness} </td>
                                    <td>{key.CWE}</td>
                                </tr>
                                ))}
