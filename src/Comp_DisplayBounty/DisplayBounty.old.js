                            ...
                            <div className="container-3">
                                <div className="container-3_column-1 shadowborder">
                        			<div className='directoryHeader'>
                        				<span>Directory Header: {ownerDisplay}</span>
                        			</div>
                                    ...
                                    <ReactMarkdown
                                        ...
                                        source={decodeURIComponent(escape(window.atob(bountyCurrent.Bountytextarea)))}
                                        escapeHtml={false}
                                     />
                                    <br/><br/>
                                    ...
                                    <a> ETH: {this.state.depositValue}</a>

                                    <br/><br/>

                                    <button name="withdrawValue" onClick={this.withdraw}>withdraw</button>
                                    {/* <button id="contractValue" onClick={() => {withdraw(bountyCurrent.address)}}>withdraw</button> */}
